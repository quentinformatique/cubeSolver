...
##################################################################################
    ...
    # get a subframe of 50x50 pixels and get its average color then display it
